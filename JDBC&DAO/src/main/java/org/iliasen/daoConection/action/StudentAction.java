package org.iliasen.daoConection.action;

import org.iliasen.daoConection.dao.StudentDao;
...
public class StudentAction {
    ...
    public void fetchByName(String name){
        List<Student> studentList = Collections.singletonList(dao.fetchByName(name));
        if (studentList.isEmpty()) {
            System.out.println("No Record Found");
        } else {
            System.out.println("Student Details are :");
