...
//потока ввода
            ...
            int clientMessage = Integer.parseInt(stdin.readLine());
            System.out.println("you've entered: "+clientMessage);
            while(clientMessage > 0) {//выполнение цикла, пока строка //не будет равна «quite»
                ...
                System.out.println("---------------------------");
                clientMessage = Integer.parseInt(stdin.readLine());//ввод текста с клавиатуры
